...
$dadosboleto["nosso_numero"] = '00000'.$_REQUEST['NOSSO_NUMERO']; //"0000000123456";  // Nosso numero - REGRA: Máximo de 13 caracteres!
...
$dadosboleto["demonstrativo2"] = 'NUMERO DE INSCRIÇÃO: Nº '.$_REQUEST['NUM_INSCRICAO']; //"Mensalidade referente a nonon nonooon nononon<br>Taxa bancária - R$ ".number_format($taxa_boleto, 2, ',', '');
...
$dadosboleto["instrucoes1"] = $demonstrativo1; //"- Sr. Caixa, cobrar multa de 2% após o vencimento";
$dadosboleto["instrucoes2"] = $_REQUEST['NOME']; //"- Receber até 10 dias após o vencimento";
$dadosboleto["instrucoes3"] = 'NUMERO DE INSCRICAO: Nº '.$_REQUEST['NUM_INSCRICAO']; //"- Em caso de dúvidas entre em contato conosco: xxxx@xxxx.com.br";
